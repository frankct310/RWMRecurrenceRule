...
public class RWMRuleScheduler {
    ...
    ///   - date: The date.
    ///   - stop: The stop.
    public func enumerateDates(with rule: RWMRecurrenceRule, startingFrom start: Date, inTimeZone: TimeZone = TimeZone.current, using block: (_ date: Date?, _ stop: inout Bool) -> Void) {
